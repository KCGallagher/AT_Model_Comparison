# ====================================================================================
# All code credit to Maximilian Strobl
# ====================================================================================
import re
import numpy as np
import pandas as pd
...
# ====================================================================================
def residual(params, data, model, feature, solver_kws={}, residual_kws={}):
...
def residual_multipleConditions(params, x, data, model, model_to_observation_map, split_by,
    ...
    for condition in data[split_by].unique():
        ...
        tmpList.append(residual(params, x, currData, model, model_to_observation_map, solver_kws=solver_kws, residual_kws=residual_kws))
...
# ====================================================================================
def load_fit(modelName, fitId=0, file_name_model=None, fitDir="./", load_bootstraps=False, file_name_bootstraps=None, **kwargs):
...
def compute_confidenceInterval_prediction(fitObj, bootstrapResultsDf, alpha=0.95,
    ...
    n_stateVars = len(LotkaVolterraModel(**model_kws).stateVars)
    ...
    for bootstrapId in tqdm(np.arange(n_bootstraps), disable=(show_progress == False)):
        ...
        tmpModel = LotkaVolterraModel(**model_kws)
        currParams = fitObj.params.copy()
